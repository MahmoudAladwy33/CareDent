...
import '../../features/get_available_appointments/data/repos/accept_appointment_repo.dart';
...
Future<void> setupGetIt() async {
  ...
  //accept appointment
  getIt.registerLazySingleton<AcceptAppointmentRepo>(
    () => AcceptAppointmentRepo(getIt()),
  );
