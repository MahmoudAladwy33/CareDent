...
abstract class _$$UpdatedImplCopyWith<T, $Res> {
  factory _$$UpdatedImplCopyWith(
    _$UpdatedImpl<T> value,
    $Res Function(_$UpdatedImpl<T>) then,
...
class __$$UpdatedImplCopyWithImpl<T, $Res>
    extends _$SignUpStateCopyWithImpl<T, $Res, _$UpdatedImpl<T>>
    implements _$$UpdatedImplCopyWith<T, $Res> {
  __$$UpdatedImplCopyWithImpl(
    _$UpdatedImpl<T> _value,
    $Res Function(_$UpdatedImpl<T>) _then,
  ) : super(_value, _then);
...
class _$UpdatedImpl<T> implements Updated<T> {
  ...
  @override
  String toString() {
    return 'SignUpState<$T>.updated(data: $data)';
  }
...
abstract class Updated<T> implements SignUpState<T> {
