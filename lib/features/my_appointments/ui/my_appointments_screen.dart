...
import 'package:caredent/features/my_appointments/logic/get_student_appointments_cubit/get_student_appointments_cubit.dart';
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create:
              (context) =>
                  getIt<GetStudentAppointmentsCubit>()
