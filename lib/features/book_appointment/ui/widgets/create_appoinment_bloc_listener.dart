...
import 'package:caredent/features/book_appointment/logic/cubit/create_appoinment_state.dart';
...
class CreateAppoinmentBlocListener extends StatelessWidget {
  const CreateAppoinmentBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<CreateAppoinmentCubit, CreateAppoinmentState>(
      listenWhen:
          (previous, current) =>
