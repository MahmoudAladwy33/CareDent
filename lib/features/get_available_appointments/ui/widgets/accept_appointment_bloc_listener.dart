...
import '../../logic/cubit/accept_appointment_state.dart';

class AcceptAppointmentBlocListener extends StatelessWidget {
  const AcceptAppointmentBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<AcceptAppointmentCubit, AcceptAppointmentState>(
      listenWhen:
          (previous, current) =>
      ...
      listener: (context, state) {
        state.whenOrNull(
          ...
          success: (acceptAppointmentResponse) {
            context
                .read<GetAvailableAppointmentsCubit>()
